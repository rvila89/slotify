...
export type UpdateReservaRequest = components['schemas']['UpdateReservaRequest'];
export type CambiarFechaRequest = components['schemas']['CambiarFechaRequest'];
export type CambiarFechaConflictoError = components['schemas']['CambiarFechaConflictoError'];
...
export type ResultadoVisitaRequest = components['schemas']['ResultadoVisitaRequest'];
export type ResultadoVisita = components['schemas']['ResultadoVisita'];
