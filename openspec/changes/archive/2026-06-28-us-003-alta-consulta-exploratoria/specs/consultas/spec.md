...
> Capability de **gestión de leads y fase de consulta de la RESERVA**: alta manual
> de leads y respuesta inicial automática (email E1). La consulta es una **fase del
> agregado raíz RESERVA**, no una entidad separada.
> Fuente: US-003, UC-03, `er-diagram.md §3.4, §3.6, §3.17`, `data-model.md`,
> `architecture.md`.
