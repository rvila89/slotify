...
> Capability de **autenticación transversal**: emisión y renovación de tokens,
> verificación de credenciales, sesión en memoria del frontend y auditoría del
> acceso. No pertenece a M1–M12 de negocio; es capa transversal de infraestructura
> (`SlotifyGeneralSpecs §3.1`).
> Fuente: US-001, UC-01, `architecture.md §2.8`, `er-diagram §3.3, §3.17`.
