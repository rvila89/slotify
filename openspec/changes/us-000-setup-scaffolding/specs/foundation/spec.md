# Spec Delta — Capability `foundation`

> Capability de infraestructura / fundación de datos. Fuente: US-000,
> `architecture.md §1–§2`, `er-diagram.md`. Sin UC funcional asociado (habilita UC-01..UC-36).
