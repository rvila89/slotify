...
| **Prioridad** | Alta |
| **Frecuencia** | Media |
| **US** | US-031 (flujo básico automático); US-032 (forzado manual — implementado); US-033 (captura de documentación — pendiente); US-034 (finalización del evento — implementada) |
